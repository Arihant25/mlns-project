...
======================
Phase 1A — Step 1: Load the Solubility_AqSolDB dataset from TDC, generate frozen
...
def main():
    ...
    # 1. Load the Solubility_AqSolDB dataset via PyTDC
    print("[1/4] Loading Solubility (AqSolDB) dataset from TDC …")
