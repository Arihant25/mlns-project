...
def main():
    ...
    lines = [
        ...
        f"Architecture: XGBRegressor(n_estimators=300, lr=0.05, max_depth=3, "
        f"colsample_bytree=0.3, subsample=0.8, reg_alpha=1.0, reg_lambda=1.0)",
        "",
        header, sep,
    ]
    for r in results:
